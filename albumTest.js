...
end_button1.addEventListener("click", function() {
  ...
  document.getElementById('mySlidesHeadline1').innerText = document.getElementById('edit1').innerText;
  document.getElementById('mySlidesDescription1').innerText = document.getElementById('editDesc1').innerText;
...
end_button2.addEventListener("click", function() {
  ...
  // UPDATES THE TITLE IN THE MODAL WHEN THE BUTTON IS PRESSED
  document.getElementById('mySlidesHeadline2').innerText = document.getElementById('edit2').innerText;
  document.getElementById('mySlidesDescription2').innerText = document.getElementById('editDesc2').innerText;
} )
...
end_button3.addEventListener("click", function() {
  ...
  // UPDATES THE TITLE IN THE MODAL WHEN THE BUTTON IS PRESSED
  document.getElementById('mySlidesHeadline3').innerText = document.getElementById('edit3').innerText;
  document.getElementById('mySlidesDescription3').innerText = document.getElementById('editDesc3').innerText;
} )
...
end_button4.addEventListener("click", function() {
  ...
  // UPDATES THE TITLE IN THE MODAL WHEN THE BUTTON IS PRESSED
  document.getElementById('mySlidesHeadline4').innerText = document.getElementById('edit4').innerText;
  document.getElementById('mySlidesDescription4').innerText = document.getElementById('editDesc4').innerText;
} )
...
end_button5.addEventListener("click", function() {
  ...
  // UPDATES THE TITLE IN THE MODAL WHEN THE BUTTON IS PRESSED
  document.getElementById('mySlidesHeadline5').innerText = document.getElementById('edit5').innerText;
  document.getElementById('mySlidesDescription5').innerText = document.getElementById('editDesc5').innerText;
} )
...
end_button6.addEventListener("click", function() {
  ...
  // UPDATES THE TITLE IN THE MODAL WHEN THE BUTTON IS PRESSED
  document.getElementById('mySlidesHeadline6').innerText = document.getElementById('edit6').innerText;
  document.getElementById('mySlidesDescription6').innerText = document.getElementById('editDesc6').innerText;
} )
